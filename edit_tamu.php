...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM tb_tamu WHERE id = $id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $bukti = $data['bukti']; // Keep existing bukti if no new file uploaded
    ...
    // Update data
    $query_update = "UPDATE tb_tamu SET tanggal='$tanggal', nama='$nama', alamat='$alamat', instansi='$instansi', tujuan='$tujuan', bidang='$bidang' WHERE id=$id";
    if (mysqli_query($koneksi, $query_update)) {
        header("Location: data_tamu.php?success=2");
        exit();
    } else {
...
<head>
    ...
    <title>Edit Tamu - Buku Tamu Diskominfo Kabupaten Karimun</title>
    <link rel="icon" href="img/diskominfotbk.jpg">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <link href="css/edit_tamu.css" rel="stylesheet">
</head>
<body>
    <!-- Navbar -->
        ...
        <div class="row g-0">
            ...
            <main class="col-md-10 ms-sm-auto px-4">
                ...
                <div class="content-header">
                    <h1 class="fw-bold mb-0">Edit Tamu & Instansi</h1>
                    <p class="mb-0 text-muted">Form Edit Data Tamu & Instasnsi</p>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="instansi" name="instansi" value="<?php echo $data['instansi']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="tujuan" class="form-label">Keperluan</label>
                                        <input type="text" class="form-control" id="tujuan" name="tujuan" value="<?php echo $data['tujuan']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="bidang" class="form-label">Bidang</label>
                                        <select class="form-select" id="bidang" name="bidang" required>
                                            <option value="">Pilih Bidang</option>
                                            <option value="Bidang Sekretariat & Umum" <?php if($data['bidang'] == 'Bidang Sekretariat & Umum') echo 'selected'; ?>>Bidang Sekretariat & Umum</option>
                                            <option value="Bidang Pengelolaan dan Layanan Informasi Publik" <?php if($data['bidang'] == 'Bidang Pengelolaan dan Layanan Informasi Publik') echo 'selected'; ?>>Bidang Pengelolaan dan Layanan Informasi Publik</option>
                                            <option value="Bidang Komunikasi Publik dan Kehumasan" <?php if($data['bidang'] == 'Bidang Komunikasi Publik dan Kehumasan') echo 'selected'; ?>>Bidang Komunikasi Publik dan Kehumasan</option>
                                            <option value="Bidang TIK" <?php if($data['bidang'] == 'Bidang TIK') echo 'selected'; ?>>Bidang TIK</option>
                                            <option value="Bidang Statistik & Persandian" <?php if($data['bidang'] == 'Bidang Statistik & Persandian') echo 'selected'; ?>>Bidang Statistik & Persandian</option>
                                        </select>
                                    </div>
